		...
		animate: function() {
			...
			if (!$('html').hasClass('no-csstransitions') && $(window).width() > self.options.minWindowWidth && elTopDistance >= windowTopDistance) {
				...
				$el.appear(function() {
					...
					$el.one('animation:show', function() {
...
(function(theme, $) {
	...
	let instanceName = '__carousel';

	let PluginCarousel = function($el, opts) {
		return this.initialize($el, opts);
	};
...
(function(theme, $) {
	...
	let instanceName = '__IOS7Switch';

	let PluginIOS7Switch = function($el) {
	...
	PluginIOS7Switch.prototype = {
		...
		build: function() {
			let switcher = new Switch( this.$el.get(0) );
...
(function(theme, $) {
	...
	let PluginMultiSelect = function($el, opts) {
		return this.initialize($el, opts);
	};
...
(function(theme, $) {
	...
	Mailbox.prototype = {
		...
		eventsCompose: function() {
			...
			let adjustComposeSize = function() {
				let composerHeight,
					composerTop,
